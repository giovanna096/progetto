...
<html>
	<head>
		...
		<div style="margin-top: 28px; height: 105px; text-align: left; margin-left: 359px; width: 725px;">
			...
			<a href="visualizzaImpianto1.php" TITLE="visualizzaImpianto"> <img style="border: 0px solid ; width: 272px; height: 247px;" class="classname" src="images/impianto.jpg" ALT="logo"></a>
		</div>
			...
			<a href="visualizzaSensore1.php" TITLE="visualizzaSensore"> <img style="border: 0px solid ; width: 272px; height: 247px;" class="classname" src="images/sensore.png" ALT="logo"></a>
		</div>
		<div style="overflow: hidden; width: auto ! important; margin-top: 139px; height: 283px; text-align: center; margin-left: 68px;" class="wrapper">
			<div style="text-align: left; width: 284px;">
				<a href="visualizzaAdattatore1.php" TITLE="visualizzaAdattatore"><img style="border: 0px solid ; width: 272px; height: 247px;" class="classname" src="images/adattatore.jpg" ALT="logo"></a>
			</div>
		</div>
