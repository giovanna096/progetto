...
<?php
    ...
    //comando SQL
    $sql = "SELECT id_dato, id_impianto, id_sensore, data, ora, valore, info, tipo, dimensione, stato, id_cliente FROM datirilevati INNER JOIN impianto ON id=id_impianto WHERE Id_cliente='%s' ";
